...
export const ComposeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        sendEmailApiV1ComposeComposeSendPost: async (
            ...
            const localVarPath = `/api/v1/compose/send`;
...
export const ComposeApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async sendEmailApiV1ComposeComposeSendPost(
            ...
            const localVarOperationServerBasePath = operationServerMap['ComposeApi.sendEmailApiV1ComposeComposeSendPost']?.[localVarOperationServerIndex]?.url;
...
export class ComposeApi extends BaseAPI {
    ...
    public sendEmailApiV1ComposeComposeSendPost(
        ...
        return ComposeApiFp(this.configuration)
            .sendEmailApiV1ComposeComposeSendPost(emailData, smtpMode, smtpIds, count, templates, file, options)
