...
const ProxyCheckerConsole = ({ className = "" }: { className?: string }) => {
  ...
  // Status colors
  const statusColors = {
    testing: 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400',
    active: 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400',
    failed: 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400',
    timeout: 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-400',
    banned: 'bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-400',
    slow: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400',
    anonymous: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/20 dark:text-cyan-400'
  };
