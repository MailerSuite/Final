...
const SecurityPage: React.FC = () => {
  ...
  const fetchData = useCallback(async (searchQuery?: string, statusFilter?: string, offset = 0) => {
    ...
    try {
      ...
      const response = await axiosInstance.get<SecurityResponse>(
        `/api/v1/security?${params}`
      );
    ...
    return (
      <PageWrapper title="Security">
        <Alert>
          ...
          <AlertDescription>
            Please log in to access Security.
          </AlertDescription>
        </Alert>
      </PageWrapper>
    );
            ...
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground">
                  Get started by creating your first security item.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
