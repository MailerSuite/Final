      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gradient-to-br from-primary/10 to-green-500/10 rounded-lg border border-primary/20">
        ...
        <div className="flex items-center gap-4">
          <Button
            ...
            disabled={loading}
            className="bg-gradient-to-r from-primary to-green-600 hover:from-primary/90 hover:to-green-500"
          >
            {loading ? (
