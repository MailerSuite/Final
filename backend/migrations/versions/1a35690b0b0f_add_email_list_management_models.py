"""Add email list management models

Revision ID: 1a35690b0b0f
Revises: edda0b5f0d73
Create Date: 2025-07-31 14:07:57.854656
...
revision: str = '1a35690b0b0f'
down_revision: Union[str, None] = 'edda0b5f0d73'
...
def upgrade() -> None:
    ...
    sa.Column('two_factor_secret', sa.String(length=6), nullable=True),
    sa.Column('two_factor_secret_expires', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('sent_emails', sa.Integer(), nullable=True),
    sa.Column('failed_emails', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('double_optin_required', sa.Boolean(), nullable=False),
    sa.Column('send_welcome_email', sa.Boolean(), nullable=False),
    sa.Column('welcome_email_template_id', sa.UUID(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_email_lists_id'), 'email_lists', ['id'], unique=False)
    ...
    sa.Column('used_for_customer_id', sa.String(length=36), nullable=True),
    ...
    op.create_table('lead_bases',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('total_leads', sa.Integer(), nullable=True),
    sa.Column('verified_leads', sa.Integer(), nullable=True),
    sa.Column('last_updated', sa.DateTime(timezone=True), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    ...
    sa.Column('last_bounce_date', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('payment_request_id', sa.String(length=36), nullable=True),
    ...
    op.create_index('idx_webhook_created_at', 'webhook_endpoints', ['created_at'], unique=False)
    # Skip GIN index on JSON column - not supported without operator class
    # op.create_index('idx_webhook_events', 'webhook_endpoints', ['events'], unique=False)
    op.create_index('idx_webhook_last_delivery', 'webhook_endpoints', ['last_delivery_at'], unique=False)
    op.create_index('idx_webhook_user_active', 'webhook_endpoints', ['user_id', 'is_active'], unique=False)
    ...
    # Skip GIN index on JSON column - not supported without operator class
    # op.create_index('idx_webhook_event_data', 'webhook_events', ['data'], unique=False)
    op.create_index('idx_webhook_event_processed', 'webhook_events', ['is_processed', 'timestamp'], unique=False)
    op.create_index('idx_webhook_event_type_timestamp', 'webhook_events', ['event_type', 'timestamp'], unique=False)
    op.create_index('idx_webhook_event_user', 'webhook_events', ['user_id', 'timestamp'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['lead_base_id'], ['lead_bases.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('email_list_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_list_imports_id'), 'list_imports', ['id'], unique=False)
    op.create_table('list_subscriber_association',
    sa.Column('list_id', sa.UUID(), nullable=False),
    sa.Column('subscriber_id', sa.UUID(), nullable=False),
    sa.Column('joined_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('status', sa.String(length=20), nullable=True),
    sa.ForeignKeyConstraint(['list_id'], ['email_lists.id'], ),
    sa.ForeignKeyConstraint(['subscriber_id'], ['subscribers.id'], ),
    sa.PrimaryKeyConstraint('list_id', 'subscriber_id')
    )
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('email_list_id', sa.UUID(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    op.create_table('subscriber_activities',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('subscriber_id', sa.UUID(), nullable=False),
    sa.Column('campaign_id', sa.UUID(), nullable=True),
    ...
    op.create_index(op.f('ix_subscriber_activities_id'), 'subscriber_activities', ['id'], unique=False)
    ...
    sa.Column('current_address_id', sa.String(length=36), nullable=True),
    ...
    op.create_index('idx_webhook_delivery_event', 'webhook_deliveries', ['event_id', 'created_at'], unique=False)
    op.create_index('idx_webhook_delivery_retry', 'webhook_deliveries', ['next_retry_at', 'retry_count'], unique=False)
    op.create_index('idx_webhook_delivery_status', 'webhook_deliveries', ['is_successful', 'created_at'], unique=False)
    op.create_index('idx_webhook_delivery_status_code', 'webhook_deliveries', ['status_code', 'created_at'], unique=False)
    op.create_index('idx_webhook_delivery_webhook', 'webhook_deliveries', ['webhook_id', 'created_at'], unique=False)
    ...
    op.create_index(op.f('ix_segment_conditions_id'), 'segment_conditions', ['id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['layout_id'], ['template_layouts.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_segment_conditions_id'), table_name='segment_conditions')
    ...
    op.drop_index(op.f('ix_subscriber_activities_id'), table_name='subscriber_activities')
    op.drop_table('subscriber_activities')
    op.drop_table('sessions')
    op.drop_index(op.f('ix_segments_id'), table_name='segments')
    op.drop_table('segments')
    op.drop_table('payment_requests')
    op.drop_table('list_subscriber_association')
    op.drop_index(op.f('ix_list_imports_id'), table_name='list_imports')
    ...
    # Index was commented out in upgrade, so no need to drop
    # op.execute('DROP INDEX IF EXISTS idx_webhook_event_data')
    ...
    # Index was commented out in upgrade, so no need to drop
    # op.execute('DROP INDEX IF EXISTS idx_webhook_events')
    ...
    op.drop_index(op.f('ix_email_lists_id'), table_name='email_lists')
