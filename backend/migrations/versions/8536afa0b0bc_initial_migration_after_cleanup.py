...
Revision ID: 8536afa0b0bc
Revises: 
Create Date: 2025-07-29 13:00:42.766079
...
revision: str = '8536afa0b0bc'
down_revision: Union[str, None] = '1a35690b0b0f'
...
def upgrade() -> None:
    ...
    op.create_index('idx_smtp_accounts_user_id', 'smtp_accounts', ['user_id'], unique=False)
    op.create_index('idx_smtp_accounts_active', 'smtp_accounts', ['is_active'], unique=False)
    op.create_index('idx_smtp_accounts_user_active', 'smtp_accounts', ['user_id', 'is_active'], unique=False)
    ...
    op.create_index('idx_proxy_servers_user_id', 'proxy_servers', ['user_id'], unique=False)
    op.create_index('idx_proxy_servers_active', 'proxy_servers', ['is_active'], unique=False)
    op.create_index('idx_proxy_servers_user_active', 'proxy_servers', ['user_id', 'is_active'], unique=False)
    ...
    op.create_index('idx_imap_accounts_user_id', 'imap_accounts', ['user_id'], unique=False)
    op.create_index('idx_imap_accounts_active', 'imap_accounts', ['is_active'], unique=False)
    ...
    op.alter_column('bulk_mail_jobs', 'id',
               existing_type=sa.UUID(),
               type_=sa.String(length=36),
               existing_nullable=False,
               existing_server_default=sa.text('gen_random_uuid()'))
    op.alter_column('bulk_mail_jobs', 'user_id',
               existing_type=sa.UUID(),
               nullable=False)
    ...
    op.alter_column('email_templates', 'user_id',
               existing_type=sa.UUID(),
               nullable=False)
    op.alter_column('email_templates', 'layout_id',
               existing_type=sa.UUID(),
               type_=sa.String(length=36),
    ...
    op.drop_column('smtp_accounts', 'response_time')
    op.drop_column('smtp_accounts', 'last_checked')
    op.drop_column('smtp_accounts', 'status')
    op.drop_column('smtp_accounts', 'error_message')
    op.drop_column('smtp_accounts', 'is_checked')
...
def downgrade() -> None:
    ...
    op.add_column('smtp_accounts', sa.Column('is_checked', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.add_column('smtp_accounts', sa.Column('error_message', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('smtp_accounts', sa.Column('status', sa.VARCHAR(length=20), autoincrement=False, nullable=True))
    op.add_column('smtp_accounts', sa.Column('last_checked', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('smtp_accounts', sa.Column('response_time', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
